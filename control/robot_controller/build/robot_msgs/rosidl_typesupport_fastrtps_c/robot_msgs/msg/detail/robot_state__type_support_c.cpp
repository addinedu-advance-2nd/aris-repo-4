...
#include "rosidl_runtime_c/primitives_sequence.h"  // angles, positions, temperatures
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // angles, positions, temperatures
  ...
  size_t current_alignment)
{
  ...
  // field.name position_code
  {
    size_t item_size = sizeof(ros_message->position_code);
