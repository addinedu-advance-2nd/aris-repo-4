...
bool robot_msgs__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // position_code
    PyObject * field = PyObject_GetAttrString(_pymsg, "position_code");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->position_code = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // positions
...
PyObject * robot_msgs__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // position_code
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->position_code);
    {
      int rc = PyObject_SetAttrString(_pymessage, "position_code", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
